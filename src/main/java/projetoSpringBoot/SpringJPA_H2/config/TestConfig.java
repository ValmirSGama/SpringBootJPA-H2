...
import projetoSpringBoot.SpringJPA_H2.entities.Payment;
...
import projetoSpringBoot.SpringJPA_H2.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Associação dos produtos às sua categorias
		...
		// Salvando os produtos com às Associação no array list
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		Payment pay1 = new Payment(null, Instant.parse("2024-07-29T21:53:07Z"), o1);
		o1.setPayment(pay1);
