...
public class UserResource {
	...
	// Implementação do endpoint para inserir um usuário no banco de dados
	@PostMapping
	...
	// Implementação do endpoint para deletar um usuário no banco de dados
	...
	// Implementação do endpoint para atualizar um usuário no banco de dados
	@PutMapping(value = "/{id}")
